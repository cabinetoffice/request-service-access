export enum ErrorMessages {
  ...
  EMAIL_ADDRESS = 'Enter the email address of the GitHub account holder',
  CONTRACT_TYPE = 'Select the GitHub account holders contract type',
  CONTRACT_START_DATE= 'Enter the GitHub account holders contract start date in the correct format',
  CONTRACT_DATE_TIME= 'The contract start date cannot be more than one year in the future',
