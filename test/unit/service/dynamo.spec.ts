...
import { MOCK_APP_DATA, MOCK_SUBMISSION_ID, MOCK_EMAIL, MOCK_DYNAMODB_RECORD } from '../../mock/data';
...
describe('Dynamo submission service unit test suites', () => {
    ...
    test('it should call Dynamo DB methods and marshall util with correct params if feature flag is enabled and NODE_ENV is production', async () => {
        ...
        await putSubmission(MOCK_SUBMISSION_ID, MOCK_EMAIL, MOCK_APP_DATA);
    ...
    test('it should not call marshall util or Dynamo DB methods if feature flag is disabled', async () => {
